...
* Reworked the decision overview: filters on Type, Område and Friststatus, sorted by soonest deadline first with expired decisions last, with the deadline shown on teasers and the detail page following the existing card/header conventions
